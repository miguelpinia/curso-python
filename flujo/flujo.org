...
alimente. Mientras que la función *xrange* crea un
generador de números y los va creando conforme los va
necesitando.

Es por esto que siempre se prefiere usar *xrange* sobre *range*.
